...
<html>
    ...
    <body>
          <%
           long senderAcc=Long.parseLong(request.getParameter("accountNo"));
           long recieverAcc=Long.parseLong(request.getParameter("accountNo"));
           long ammount=Long.parseLong(request.getParameter("ammount"));

            //  out.print(u.getAmmount());
           
           AccountDao obj=new AccountDao();
          boolean i= obj.transfer(senderAcc, recieverAcc, ammount);
       if(i){
              %>
    <center><h4>Transfer Successfully</h4></center>
    <%
