               ...
               <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown">
                     ...
                     <ul class="dropdown-menu">
                        <li class="active"><a href="credit.jsp">Credit</a></li>
        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                      <form method="POST" id="signup-form" class="signup-form" action="credit_db.jsp">
                        <h2 class="form-title">Credit Money</h2>
                        ...
                        <div class="form-group">
                            <input type="submit" name="submit" id="submit" class="form-submit" value="Credit"/>
                        </div>
                    </form>
                </div>
            </div>
