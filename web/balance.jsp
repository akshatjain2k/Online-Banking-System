        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                      <form method="POST" id="signup-form" class="signup-form" action="balance_db.jsp">
                        <h2 class="form-title">Balance Enquriy</h2>
                        ...
                        <div class="form-group">
                            <input type="submit" name="submit" id="submit" class="form-submit" value="Check balance"/>
                        </div>
                    </form>
                </div>
            </div>
