        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                      <form method="POST" id="signup-form" class="signup-form" action="accountDetail_db.jsp">
                        <h2 class="form-title">Account Detail</h2>
                        ...
                        <div class="form-group">
                            <input type="submit" name="submit" id="submit" class="form-submit" value="Detail"/>
                        </div>
                    </form>
                </div>
            </div>
