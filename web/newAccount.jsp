               ...
               <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown">
                     ...
                     <ul class="dropdown-menu">
                        ...
                        <li class="divider"></li>
                        <li class="active"><a href="newAccount.jsp">Create New Account</a></li>
                     </ul>
                  </li>
                   <li class="dropdown">
        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                      <form method="POST" id="signup-form" class="signup-form" action="newAccount_db.jsp">
                        <h2 class="form-title">Create New Bank Account</h2>
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <input type="text" class="form-input" name="accountNo" id="name" placeholder="Your Account Number" required/>
                        </div>
                              
                         <div class="form-group">
                            <input type="text" class="form-input" name="ammount" id="name" placeholder="Enter Starting Ammount" required/>
                        </div>
                        ...
                        <div class="form-group">
                            <input type="submit" name="submit" id="submit" class="form-submit" value="Create New Account"/>
                        </div>
                    </form>
                </div>
            </div>
